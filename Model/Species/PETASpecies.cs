...
{
    public class PETASpecies : BoidSpecies
    {
        ...
        public static Parameter<string> EnemySpecies = new Parameter<string>("Repulsive Species", "prey");

        public static Parameter<string> FriendSpecies = new Parameter<string>("Attractive Species", "hunter");

        public PETASpecies(World world)
            : base(world, "peta")
        {
            Bindings
